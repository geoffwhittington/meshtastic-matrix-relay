...
class TestCLIEdgeCases(unittest.TestCase):
    ...
    def test_parse_arguments_windows_both_positional_and_flag(self):
        ...
        with patch('sys.platform', 'win32'):
            with patch('sys.argv', ['mmrelay', '--config', 'flag_config.yaml', 'pos_config.yaml']):
                args = parse_arguments()
    ...
    def test_check_config_missing_required_sections(self):
        ...
        invalid_configs = [
            ...
            {'matrix': {'homeserver': 'test'}, 'meshtastic': {}},  # Missing matrix_rooms
            {'matrix': {'homeserver': 'test', 'access_token': 'test', 'bot_user_id': 'test'}},  # Missing meshtastic
        ]
